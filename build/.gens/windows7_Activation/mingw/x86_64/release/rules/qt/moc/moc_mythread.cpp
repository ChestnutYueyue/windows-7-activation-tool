...
QT_MOC_LITERAL(3, 19, 8), // "_message"
QT_MOC_LITERAL(4, 28, 8) // "SendKeys"

    },
    "MyThread\0finished\0\0_message\0SendKeys"
};
...
void MyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->SendKeys((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (MyThread::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyThread::SendKeys)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void MyThread::SendKeys(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
